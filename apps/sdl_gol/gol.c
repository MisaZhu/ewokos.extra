...
const Uint32 STARTING_POPULATION = 2000;
...
int main(int argc, char** argv)
{
    ...
    Uint32 ticks_per_lifecycle = 200;
...
void update_button_states( buttons *bts, SDL_Event e, bool isKeydown )
{
  switch ( e.key.keysym.sym)
    ...
    case SDLK_a:
      ...
      break;
    case SDLK_b:
      bts->bButtonDown = isKeydown;
      break;
    case SDLK_x:
      bts->xButtonDown = isKeydown;
      break;
    case SDLK_y:
      bts->yButtonDown = isKeydown;
      break;
    case SDLK_UP:
    ...
    case SDLK_DOWN:
      ...
      break;
    case SDLK_LEFT:
      bts->leftButtonDown = isKeydown;
      break;
    case SDLK_RIGHT:
      bts->rightButtonDown = isKeydown;
      break;
    }
}
