...
{
    sz.width = 100;  // Fixed width for input elements
    sz.height = 24;
...
void el_input::draw(litehtml::uint_ptr hdc, int x, int y, const litehtml::position* clip)
{
    ...
    case HtmlInputType::TEXT:
        rectangleRGBA(m_renderer, pos.x, pos.y, pos.x + pos.width, pos.y + pos.height, 100, 100, 100, 255);
        break;
    case HtmlInputType::BUTTON:
        roundedRectangleRGBA(m_renderer, pos.x, pos.y, pos.x + pos.width, pos.y + pos.height, 6, 100, 100, 100, 255);
        break;
    }
