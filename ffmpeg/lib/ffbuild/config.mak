...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=../../../system/build/virt --libdir=../../../system/build/virt/lib --incdir=../../../system/build/virt/include --pkgconfigdir=../../../system/build/virt/lib/pkgconfig --enable-cross-compile --arch=aarch64 --target-os=linux --cross-prefix=aarch64-none-elf- --cc=aarch64-none-elf-gcc --cxx=aarch64-none-elf-c++ --ar=aarch64-none-elf-ar --ranlib=aarch64-none-elf-ranlib --nm=aarch64-none-elf-nm --disable-programs --disable-doc --disable-debug --disable-autodetect --disable-network --disable-iconv --disable-zlib --disable-bzlib --disable-lzma --disable-sdl2 --disable-xlib --disable-vulkan --disable-vaapi --disable-vdpau --disable-postproc --disable-avdevice --disable-avfilter --disable-pthreads --disable-w32threads --disable-os2threads --enable-asm --disable-everything --enable-static --disable-shared --enable-small --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-protocol=file --enable-demuxer='avi,flac,matroska,mov,mp3,ogg,wav' --enable-parser='aac,aac_latm,flac,h264,hevc,mpegaudio,mpeg4video,opus,vorbis' --enable-decoder='aac,flac,h264,hevc,mjpeg,mp3,mpeg2video,mpeg4,opus,pcm_f32le,pcm_s16be,pcm_s16le,pcm_u8,vorbis' --enable-bsf=aac_adtstoasc --extra-cflags='-march=armv8-a -Wno-incompatible-pointer-types -Wno-int-conversion -Wno-implicit-function-declaration -Wall -Wextra -fPIC -fno-builtin-memset -Wno-unused-parameter -mstrict-align -mno-outline-atomics -std=c99 -DBSP_BOOST -O2 -I include -I ../../../system/build/virt/include -I../../../system/build/virt/include -include ../../../system/build/virt/include/string.h -include ../../../system/build/virt/include/math.h' --extra-ldflags='-nostartfiles -nostdlib -L../../../system/build/virt/lib -Wl,-Ttext=100' --extra-libs='-Wl,--start-group -lewoksys -lc -lgloss -lgcc -Wl,--end-group -lm -lopenlibm'
prefix=../../../system/build/virt
LIBDIR=$(DESTDIR)../../../system/build/virt/lib
SHLIBDIR=$(DESTDIR)../../../system/build/virt/lib
INCDIR=$(DESTDIR)../../../system/build/virt/include
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)../../../system/build/virt/lib/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=.
SRC_LINK=.
...
CFLAGS=  -march=armv8-a -Wno-incompatible-pointer-types -Wno-int-conversion -Wno-implicit-function-declaration -Wall -Wextra -fPIC -fno-builtin-memset -Wno-unused-parameter -mstrict-align -mno-outline-atomics -std=c99 -DBSP_BOOST -O2 -I include -I ../../../system/build/virt/include -I../../../system/build/virt/include -include ../../../system/build/virt/include/string.h -include ../../../system/build/virt/include/math.h -std=c11 -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -march=armv8-a -Wno-incompatible-pointer-types -Wno-int-conversion -Wno-implicit-function-declaration -Wall -Wextra -fPIC -fno-builtin-memset -Wno-unused-parameter -mstrict-align -mno-outline-atomics -std=c99 -DBSP_BOOST -O2 -I include -I ../../../system/build/virt/include -I../../../system/build/virt/include -include ../../../system/build/virt/include/string.h -include ../../../system/build/virt/include/math.h -fPIC
...
DOXYGEN=doxygen
LDFLAGS= -nostartfiles -nostdlib -L../../../system/build/virt/lib -Wl,-Ttext=100  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
