...
struct ImGui_ImplSDL2_Data
{
    ...
    // Gamepad handling - DISABLED for ewokos
...
{
    ImGui_ImplSDL2_Data* bd = ImGui_ImplSDL2_GetBackendData();
    // For ewokos: always return main viewport regardless of window_id
    // This fixes mouse event issues when window_id doesn't match
    (void)window_id;
...
bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        // DISABLED for ewokos: Gamepad/joystick support not available
...
static void ImGui_ImplSDL2_UpdateMouseData()
{
    ...
    if (is_app_focused)
    {
        ...
        // DISABLED for ewokos: SDL_GetGlobalMouseState not available
...
static void ImGui_ImplSDL2_CloseGamepads()
{
    // No-op: gamepad support disabled
}
...
void ImGui_ImplSDL2_NewFrame()
{
    ...
    // Update game controllers (if enabled and available) - DISABLED for ewokos
