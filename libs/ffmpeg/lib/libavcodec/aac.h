...
struct AACContext {
    ...
    uint64_t perf_report_start_us;
    uint64_t perf_last_report_us;
    uint64_t perf_frames;
    uint64_t perf_frame_us;
    uint64_t perf_decode_ics_us;
    uint64_t perf_tns_parse_us;
    uint64_t perf_spectrum_us;
    uint64_t perf_spectral_to_sample_us;
    uint64_t perf_tns_apply_us;
    uint64_t perf_imdct_us;
    uint64_t perf_ltp_us;
