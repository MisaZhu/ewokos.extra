...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/misa/work/ewokos/system/build/x86 --libdir=/Users/misa/work/ewokos/system/build/x86/lib --incdir=/Users/misa/work/ewokos/system/build/x86/include --pkgconfigdir=/Users/misa/work/ewokos/system/build/x86/lib/pkgconfig --enable-cross-compile --arch=x86 --target-os=linux --cross-prefix=x86_64-elf- --cc=x86_64-elf-gcc --cxx=x86_64-elf-c++ --ar=x86_64-elf-ar --ranlib=x86_64-elf-ranlib --nm=x86_64-elf-nm --disable-programs --disable-doc --disable-debug --disable-autodetect --disable-network --disable-iconv --disable-zlib --disable-bzlib --disable-lzma --disable-sdl2 --disable-xlib --disable-vulkan --disable-vaapi --disable-vdpau --disable-postproc --disable-avdevice --disable-avfilter --disable-pthreads --disable-w32threads --disable-os2threads --enable-asm --disable-everything --enable-static --disable-shared --enable-small --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-protocol=file --enable-demuxer='avi,flac,matroska,mov,mp3,ogg,wav' --enable-parser='aac,aac_latm,flac,h264,hevc,mpegaudio,mpeg4video,opus,vorbis' --enable-decoder='aac,flac,h264,hevc,mjpeg,mp3,mpeg2video,mpeg4,opus,pcm_f32le,pcm_s16be,pcm_s16le,pcm_u8,vorbis' --enable-bsf=aac_adtstoasc --extra-cflags='-m64 -Wno-implicit-function-declaration -Wno-int-conversion -Wall -Wextra -fPIC -Wno-unused-parameter -fno-strict-aliasing -ffreestanding -mno-red-zone -std=c99 -DARCH_BOOST -O2 -I include -isystem /Users/misa/work/ewokos/system/build/x86/include  -isystem /Users/misa/work/ewokos/system/build/x86/include -include string.h -include math.h' --extra-ldflags='-nostartfiles -nostdlib -L/Users/misa/work/ewokos/system/build/x86/lib -Wl,-Ttext=100' --extra-libs='-Wl,--start-group -lewoksys -lc -lgloss -lgcc -Wl,--end-group -lm -lopenlibm' --disable-x86asm
prefix=/Users/misa/work/ewokos/system/build/x86
LIBDIR=$(DESTDIR)/Users/misa/work/ewokos/system/build/x86/lib
SHLIBDIR=$(DESTDIR)/Users/misa/work/ewokos/system/build/x86/lib
INCDIR=$(DESTDIR)/Users/misa/work/ewokos/system/build/x86/include
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)/Users/misa/work/ewokos/system/build/x86/lib/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=.
SRC_LINK=.
...
CXX=x86_64-elf-c++
AS=x86_64-elf-gcc
OBJCC=x86_64-elf-gcc
LD=x86_64-elf-gcc
DEPCC=x86_64-elf-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=x86_64-elf-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
NM_CMD=x86_64-elf-nm
METALCC=xcrun -sdk macosx metal
METALLIB=xcrun -sdk macosx metallib
RANLIB=x86_64-elf-ranlib -D
...
CFLAGS=  -m64 -Wno-implicit-function-declaration -Wno-int-conversion -Wall -Wextra -fPIC -Wno-unused-parameter -fno-strict-aliasing -ffreestanding -mno-red-zone -std=c99 -DARCH_BOOST -O2 -I include -isystem /Users/misa/work/ewokos/system/build/x86/include -isystem /Users/misa/work/ewokos/system/build/x86/include -include string.h -include math.h -std=c11 -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -m64 -Wno-implicit-function-declaration -Wno-int-conversion -Wall -Wextra -fPIC -Wno-unused-parameter -fno-strict-aliasing -ffreestanding -mno-red-zone -std=c99 -DARCH_BOOST -O2 -I include -isystem /Users/misa/work/ewokos/system/build/x86/include -isystem /Users/misa/work/ewokos/system/build/x86/include -include string.h -include math.h -fPIC
...
LD_PATH=-L
DLLTOOL=
WINDRES=x86_64-elf-windres
DOXYGEN=doxygen
LDFLAGS= -nostartfiles -nostdlib -L/Users/misa/work/ewokos/system/build/x86/lib -Wl,-Ttext=100  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
